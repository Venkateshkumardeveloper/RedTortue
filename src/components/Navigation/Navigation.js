...
//         <h1 className="text-3xl font-bold tracking-tight text-gray-900">Clothing-World</h1>
//       </div>
//     </header>
//     <main>
//       {/* <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
...
//           {/* Sidebar component, swap this element with another sidebar if you like */}
//           <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-custom-red px-6 pb-4">
//             <div className="flex h-16 shrink-0 items-center">
//               <img
//                 alt="Your Company"
//                 src={logo}
...
//                             <a
//                               href={item.href}
//                               onClick={() => setActiveNav(item.name.toLowerCase())} // Set active nav on click
//                               className={classNames(
//                                 item.name.toLowerCase() === activeNav
//                                   ? 'bg-indigo-700 text-white'
//                                   : 'text-indigo-200 hover:bg-indigo-700 hover:text-white',
//                                 'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6'
//                               )}
